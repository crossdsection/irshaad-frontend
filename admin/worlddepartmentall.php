<?php 
	...
	$getWorldData = $db->select("*","wv_ministry","wv_ministry.ministry_status = 0 ");
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12">
					    <div class="panel panel-default">
						    <div class="panel-heading">
							     <h4><i class="fa fa-building fa-fw"></i> &nbsp; &nbsp;World Departments</h4>
							</div>
								    ...
								    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
										...
										<tbody>
										   ...
										   <tr class="odd gradeX" >
                                                ...
                                                <td class="center"><a href="worlddepartmentedit.php?edit=<?=$getWorld['id'];?>">Edit</a>&nbsp;|&nbsp;<a href="worlddepartmentview.php?view=<?=$getWorld['id'];?>" >View</a>&nbsp;|&nbsp;<a href="javascript:void(0);" class="delete-department" value="<?=$getWorld['id'];?>">Delete</a> </td>
                                            </tr>
                                           <?php
										         $i++;
												 }
		...
		<script>
		 /******* Code for add department **********/ 
		    $(document).on("click", ".add-department", function(){
				 window.location.href = "worlddepartment.php";
			});
