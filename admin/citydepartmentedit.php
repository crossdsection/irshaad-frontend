...
<body>
  <div id="wrapper">
    ...
    <div id="page-wrapper">
      <div class="row">
        <div class="col-lg-12">
          <h1 class="page-header">Edit City Ministry
          </h1>
        </div>
        <!-- /.col-lg-12 -->
      </div>
...
?>
              <select class="form-control show-state-data" name="country_data">
                ...
                <option value="<?=$getCityData['country_id']?>" selected>
                  <?=$getCityData['country_name']?>
                </option>
            ...
            <div class="form-group">
              ...
              <select class="form-control show-state" name="state_data">
                <option value="00">Select State
                </option>
                <option value="<?=$getCityData['state_id'];?>" selected>
            ...
            <div class="form-group">
              ...
              <select class="form-control show-city" name="city_data">
                ...
                <option value="<?=$getCityData['city_id'];?>" selected>
