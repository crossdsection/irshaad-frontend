<?php 
	...
	$getWorldData = $db->select("wv_ministry.*,wv_countries.name, wv_states.name as state_name, wv_cities.name as city_name","wv_ministry left join wv_countries on wv_ministry.country_id = wv_countries.id left join wv_states on wv_ministry.state_id = wv_states.id and   wv_ministry.country_id = wv_states.country_id left join wv_cities on wv_ministry.city_id = wv_cities.id and wv_ministry.state_id = wv_cities.state_id","wv_ministry.ministry_status = 3");
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12">
					    <div class="panel panel-default">
						    <div class="panel-heading">
							     <h4><i class="fa fa-building fa-fw"></i> &nbsp; &nbsp;City Departments</h4>
							</div>
								    ...
								    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
										...
										<tbody>
										   ...
										   <tr class="odd gradeX" >
                                                ...
                                                <td class="center"><a href="citydepartmentedit.php?edit=<?=$getWorld['id'];?>">Edit</a>&nbsp;|&nbsp;<a href="citydepartmentview.php?view=<?=$getWorld['id'];?>" >View</a>&nbsp;|&nbsp;<a href="javascript:void(0);" class="delete-department" value="<?=$getWorld['id'];?>">Delete</a> 
 ...
 <!-- DataTables JavaScript -->
		...
		<script>
		    ...
		    $(document).on("click", ".add-department", function(){
				 window.location.href = "citydepartment.php";
			});
