        ...
        <div class="container">
			<div class="row" >
				 <div class="col-md-4 col-xs-4 divide_border">
					<h3 class="divide_menu">Courts</h3>
				 </div>
				 <div class="col-md-4 col-xs-4  divide_border">
					<h3 class="divide_menu">discussion</h3>
				 </div>
				 <div class="col-md-4 col-xs-4  divide_border">
					<h3 class="divide_menu">news</h3>
				 </div>
			</div>
		</div>
			        ...
			        <ul style="list-style-type:none">
			                ...
			                <div class="row polls_section">
				                <div class="row" style="margin-bottom: 4px;">
									<div class="col-md-2 col-xs-3 col-sm-3">
										<a href="#"  data-toggle="modal" data-target="#profile"><img src="../assets/img/12.jpg" class="pro_image" /></a>
									</div>
									<div class="col-md-10">
										<p class="user_head">Name<br>Place</p>
										<p style="float:right;margin-top: 10px;">Date</p>
									</div>
								</div>
			                    ...
			                    <div class="row " style="background:white;padding-right:15px;padding-left:15px;">
			                         <h4 class="text-info" style="text-transform:capitalize;width:100%;word-wrap: break-word;font-weight:600">Pictures, abstract symbols, materials, and colors are among </h4>
		                        </div>
			                    <div class="row">
				                    <a><span style="float:right;margin-right: 7px;"><i style="font-size: 17px;" class="far fa-question-circle"></i></span></a>
				                </div>
			                    <div class="row">
					                <div class="col-md-12" style="bottom: 4px;padding: 3px;">
						                <div class="col-md-6 col-xs-6" style="padding-right: 5px;padding-left: 5px;">
							                <button class="btn" style=" width:100%;background: linear-gradient(#ffe45c,#ffae26);border: 1px solid #ffaa22;"><i style="color:green;font-size: 17px;"  class="fas fa-check"></i></button>
						                </div>
						                <div class="col-md-6 col-xs-6" style="padding-right: 5px; padding-left: 5px;">
							                 <button class="btn " style=" width:100%;background: linear-gradient(#ffe45c,#ffae26);border: 1px solid #ffaa22;"><i style="color:red;    font-size: 17px;" class="fas fa-times"></i></button>
						                </div>
					                </div>
			                    </div>
			                    <div class="row" style="color:grey">
				                    <a class= "col-md-2 col-xs-2" style="color:grey" ><i class="fas fa-share-alt"></i></a>

									<a class="col-md-2 col-xs-2" style="color:grey"><i class="far fa-star"></i></a>

									<a class="col-md-2 col-xs-2" style="color:grey" data-toggle="modal" data-target="#myModal"><i class="far fa-comment"></i></a>

				                    <a class="col-md-2 col-xs-2" style="color:grey"><i class="fal fa-arrow-alt-up"></i></a>

				                    <a class="col-md-2 col-xs-2" style="color:grey"><i class="far fa-flag"></i></a>

			                       <a class="col-md-2 col-xs-2" style="color:grey"><i class="fas fa-signal icon_flip" ></i></a>
			                    </div>
			               </div>
			            </li>
	                    <br><br>
						<li>
				            <div class="row polls_section">
				                ...
				                <div class="row">
				                    <a><span style="float:right;margin-right: 7px;margin-top: -20px;"><i style="font-size: 17px;" class="far fa-question-circle"></i></span></a>
									<div class="col-md-12" style="bottom: 4px;padding: 3px;">
										<div class="col-md-3 col-xs-3" style="padding-right: 5px;padding-left: 5px;">
											<button class="btn select_box" style=" " >1</button>
										</div>
										<div class="col-md-3 col-xs-3" style="padding-right: 5px; padding-left: 5px;">
											<button class="btn select_box" style="">2</button>
										</div>
										<div class="col-md-3 col-xs-3" style="padding-right: 5px;padding-left: 5px;">
											<button class="btn select_box" style="" >3</button>
										</div>
										<div class="col-md-3 col-xs-3" style="padding-right: 5px; padding-left: 5px;">
											<button class="btn select_box" style="">4</button>
										</div>
									</div>
								</div>
			                    <div class="row" style="color:grey">
				   ...
				   <ul style="list-style-type:none">
					  <li>
						 <div class="row polls_section" style="">
							...
							<div class="row " style="padding-right:15px;padding-left:15px;">
							   <div class="" style=""> <img src="../assets/img/55.jpg" class="news_img"/>
							   </div>
							</div>
							<div class="row " style=";background:white;padding-right:15px;padding-left:15px;">
							   <h4 class="text-info" style="text-transform:capitalize;width:100%;word-wrap: break-word;font-weight:600">Pictures, abstract symbols, materials, and colors are among </h4>
							...
							<div class="row " style="color:grey">
							   <a class= "col-md-2 col-xs-2" style="color:grey" ><i class="fas fa-share-alt"></i></a>
							   <a class="col-md-2 col-xs-2" style="color:grey"><i class="far fa-star"></i></a>
							   <a class="col-md-2 col-xs-2 comment" style="color:grey"  data-toggle="modal" data-target="#myModal"><i class="far fa-comment"></i></a>
							   <a class="col-md-2 col-xs-2 " style="color:grey"><i class="fal fa-arrow-alt-up"></i></a>
							   <a class="col-md-2 col-xs-2" style="color:grey"><i class="far fa-flag"></i></a>
							   <a class="col-md-2 col-xs-2" style="color:grey"><i class="fas fa-signal icon_flip" ></i></a>
							</div>
					  ...
					  <li>
						 <div class="row polls_section" >
							<div class="row" style="margin-bottom: 4px;">
							   ...
							   <div class="col-md-10">
								  <p class="user_head text-info">Name<br>Place</p>
								  <p style="float:right;margin-top: 10px;">Date</p>
							   </div>
							</div>
							<div class="row " style="padding-right:15px;padding-left:15px;">
							...
							<div class="row " style="padding-left:30px;padding-right:15px;margin-top: -8px;height:48px">
							   <p style="text-transform:capitalize;width:100%;line-height: 1.4;word-wrap: break-word;"> vjhgvjhgjhggujgkugugu</p>
							</div>
							<div>
							   <div class="row ">
								  <a><span style="float:left;margin-left: 30px;">Read More</span></a>
								  <a><span style="float:right;margin-right: 7px;"><i style="font-size: 17px;" class="far fa-question-circle"></i></span></a>
							   </div>
							   <div class="row " style="color:grey">
								  <a class= "col-md-2 col-xs-2" style="color:grey" ><i class="fas fa-share-alt"></i></a>
								  <a class="col-md-2 col-xs-2" style="color:grey"><i class="far fa-star"></i></a>
								  <a class="col-md-2 col-xs-2 comment" style="color:grey"  data-toggle="modal" data-target="#myModal"><i class="far fa-comment"></i></a>
								  <a class="col-md-2 col-xs-2" ></a>
								  <a class="col-md-2 col-xs-2" ><img src="../assets/images/icon/up.png"  style="width: 15px;margin-top: -3px;"/></a>
								  <a class="col-md-2 col-xs-2" ><img src="../assets/images/icon/eye.png"  style="width: 19px;margin-top: -3px;"/></a>
							   </div>
							</div>
						 </div>
					  </li>
   ...
   <div class="modal-dialog dialog_width">
      <div class="modal-content">
         ...
         <div class="modal-body" style="padding:0px">
            <div class="container">
               <div class="row">
                  <button style="float: left;position: absolute;margin: 10px;z-index: 22;" type="button" class="close" data-dismiss="modal">&times;</button>
                  <div class="col-md-3 " style="background:yellow">
                     <br><br>
                     <div class="">
                        <img src="../assets/img/12.jpg" style="width: 65%;
                           border-radius: 50%;
                           margin-left: 43px;" class="img-responsive" />
                     </div>
                     <div class="row">
                        <a href="#" >
                           <h4 class="txt_center"> Name</h4>
                        </a>
                        <p  class="txt_center">POST</p>
                        <p style="margin: 0 26px 10px;"> 21, north gandhi colony muzaffarnagar</p>
                     </div>
                     <div class="row " style="padding: 14px;">
                        <p>Addredss fds fs s dsdfsfsfds dsfsfs s dfsfdsfs </p>
                     </div>
                     <div class="row" style="height:50px" >
                        <div class="col-md-4 col-xs-4" style="border-top:2px solid #c2c508;border-bottom:2px solid #c2c508">
                           <p class="txt_center"><span style="font-weight:600">1000</span>
                              Courts
                           </p>
                        </div>
                     ...
                     <div class="row " style="">
                        <br><span class="col-md-offset-2 col-xs-offset-2" style="font-weight:600">User Rating</span>
                        <br><br>
                     </div>
                     <div class="row txt_center" style="">
                        <button class=" btn btn-info" >Follow</button>	<br><br>
                     </div>
                  </div>
                        ...
                        <ul  style="list-style-type:none">
                           <li>
                              <div class="row polls_section" style="   ">
                                 ...
                                 <div class="row " style="padding-right:15px;padding-left:15px;">
                                    <div class="" style=""> <img src="../assets/img/55.jpg" class="profile_news_img"/>
                                    </div>
                                 </div>
                                 <div class="row " style=";background:white;padding-right:15px;padding-left:15px;">
                                    <h4 class="text-info" style="text-transform:capitalize;width:100%;word-wrap: break-word;font-weight:600">Pictures, abstract symbols, materials, and colors are among </h4>
                                 ...
                                 <div class="row ">
                                    ...
                                    <div class="col-md-12" style="bottom: 4px;padding: 3px;">
                                       <div class="col-md-6" style="padding-right: 5px;padding-left: 5px;">
                                          <button class="btn" style=" width:100%;background: linear-gradient(#ffe45c,#ffae26);
                                             border: 1px solid #ffaa22; " ><i style="color:green;font-size: 17px;"  class="fas fa-check"></i></button>
                                       </div>
                                       <div class="col-md-6" style="padding-right: 5px; padding-left: 5px;">
                                          <button class="btn " style=" width:100%;background: linear-gradient(#ffe45c,#ffae26);
                                             border: 1px solid #ffaa22;"><i style="color:red;    font-size: 17px;" class="fas fa-times"></i></button>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="row " style="color:grey">
    ...
    <div class="modal-dialog" >
        ...
        <div class="modal-content">
			<div class="modal-header">
				...
				<h3 class="text-center modal-title" style="font-weight: 600;">ENACT</h3>
			</div>
			<div class="modal-body" style="padding: 0px 15px;">
			    <div class="row">
			        <div class="col-md-12">
					    <div class="row" style="background: #a8a7a9;">
							<textarea class="form-control" placeholder="Let's change the World" style="height:180px;padding: 26px;font-size: 18px;"></textarea>
							<div class="col-md-4 col-xs-4" style="padding-right: 0px;padding-left: 0px;">
								<button class="btn" style="background: #a8a7a9;border-radius:0px;width:100%;border: 1px solid #ccc4d4;">Polls</button>
							</div>
							<div class="col-md-4 col-xs-4" style="padding-right: 0px;padding-left: 0px;">
								<button class="btn"style="border-radius:0px;width:100%;background: #a8a7a9;border: 1px solid #ccc4d4;">Discussion</button>
							</div>
							<div class="col-md-4 col-xs-4" style="padding-right: 0px;padding-left: 0px;">
								<button class="btn"style="border-radius:0px;width:100%;background: #a8a7a9;border: 1px solid #ccc4d4;">News</button>
							</div>
						</div>
						<div class="row" style="background:#cac1c1;padding:7px">
							<span style="margin-left: 10px;"><img src="../assets/images/icon/camera.png"  /></span>
							<span><img src="../assets/images/icon/video.png" /></span>
							<span><img src="../assets/images/icon/notes.png" /></span>
							<span><img src="../assets/images/icon/loc.png" /></span>
						</div>
					    <div class="row">
										...
										<div class="tab-content">
											<div id="login" class="tab-pane fade in active register">
												<div class="container-fluid">
													<div class="row">
														<h2 class="text-center" style="color: #5cb85c;"> <strong class="login-strong"> Login  </strong></h2><hr />
															 ...
															 <div class="row">
                                                              ...
                                                              <div class="row">
																...
																<div class="row">
																    ...
																    <div class="col-sm-6 col-md-6 col-lg-6">
																	   <a href="../admin/index.php" class="subadminstyle">Login as subadmin</a>
                                                                    </div>
																...
																<div class="row">
																    <div  class="col-xs-12 col-sm-12 col-md-12">
																		<button type="submit" id="gSignInclass" class="btn btn-success btn-block btn-lg login-button"> Login </button>


																		<button type="submit" class="btn btn-success btn-block btn-lg verified-button" onclick="verifiy_account();">Verified Account</button>
																	</div>
																</div>
															   ...
															   <div class="col-sm-6 col-md-6 col-lg-6">
															    ...
															    <div class="col-sm-6 col-md-6 col-lg-6">
																   ...
																   <select class="form-control signup-as-subadmin">
																       <option value="00">Signup as subadmin
																	   </option>
          ...
          $.ajax({
			 ...
			 success:function(response)
			 {
				 response = JSON.parse(response);
					       ...
					       if (response.status == 1)
						   {
							 setTimeout(function(){  window.location.href= "index.php"; }, 800000);
                             //window.location.href = 'index.php';
