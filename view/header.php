      ...
      <section>
	      <div class="container-fluid" style="background: #013775;">
				   ...
				   <div  style="z-index: 55;position:absolute;margin-left: 88%;float: right;top: 18px;">
					  <a href="" data-toggle="modal" data-target="#loginSignup" style="font-weight:600;color: white;font-size: 19px;"><span class="glyphicon glyphicon-log-in"></span> Login/Signup</a>
				    </div>	  
					<?php
					 }
					 else
					 ...
					 <div  style="z-index: 55;position:absolute;margin-left: 83%;float: right;top: 18px;">	 
						<a href="#" style="font-weight:600;color: white;font-size: 18px;">Welcome, <?=$user->firstName." ".$user->lastName?></a> 
					  </div>	
				<?php	 }
					?>
				  ...
				  <div class="col-md-4 col-sm-4 col-xs-8">
				   ...
				   ?>
					  <span class="menu_icons">
						  <span title="Profile"><i class="far fa-user-circle"></i></span>
						  <span title="Location"><i class="far fa-compass"></i></span>
						  <span title="Notification"><i class="far fa-bell"></i></span>
						  <span title="Logout" class="logout"><i class="fas fa-sign-out-alt"></i></span>
					 </span>
					 <?php
					  }
					 ?>
	  ...
	  <div class="container-fluid">
			<div class="row scroll123">
				...
				<?php 
					 ...
					 ?> <a class="nav_menu_a nav_li_font active" href="#" >World </a> <?php
				 }
				 ?>
				</div>
				...
				<?php if(isset($user->id))
				{ ?>
				        <a class="nav_menu_a nav_li_font flagvote" href="#"  ><?=$userLocation[5]?> </a>
				<?php 
				}
                 else {
					 ?> <a class="nav_menu_a nav_li_font" href="#" >country </a> <?php
				 }
				 ?>
				</div>
				...
				{ 
			     ...
			     ?>
				    <a class="nav_menu_a nav_li_font flagvote" href="#" ><?=$state2[0]?> </a>
				<?php 
				}
                 else {
					 ?> <a class="nav_menu_a nav_li_font" href="#" >state </a> <?php
				 }
				 ?>
				</div>
				...
				<?php if(isset($user->id))
				{ ?>
				<a class="nav_menu_a nav_li_font flagvote" href="#" ><?=$userLocation[3]?> </a>
				<?php 
				}
                 else {
					 ?> <a class="nav_menu_a nav_li_font" href="#" >city </a> <?php
				 }
				 ?>
				</div>
				...
				<?php if(isset($user->id))
				{ ?>
				<a class="nav_menu_a nav_li_font flagvote" href="#" ><?=$userLocation[2]?>  </a>
				<?php 
				}
                 else {
					 ?> <a class="nav_menu_a nav_li_font" href="#" >locality </a> <?php
				 }
				 ?>
				</div>
	     ...
	     <div class="row depart">
		    <div  class="nav " style="height: 51px;">	
				<div class="col-md-4 col-xs-4 department_menu">
					<a href="#government" data-toggle="tab"><p class="depart_style">Govt. Department</br><span><i class="fas fa-chevron-down"></i></span></p></a>
				</div>
				<div class="col-md-4 col-xs-4 department_menu">
					<a href="#topNews" data-toggle="tab"><p class="depart_style">Top News</br><span><i class="fas fa-chevron-down"></i></span></p></a>
				</div>
				<div class="col-md-4 col-xs-4 department_menu">
					<a href="#myDeskboard" data-toggle="tab"><p class="depart_style">My Deskboard</br><span><i class="fas fa-chevron-down"></i></span></p></a>
				</div>
			
			</div>
			<span class="drop_ind"><i class="fas fa-chevron-down"></i></span>
			<section>
			   <div id="slide_menu" class="container-fluid tab-content category_tab" style="">
					<div class="row">
						...
						<div class="col-md-6 col-xs-2" style="margin-top: 9px;">
							<p class="toggle_text">Normal Mode</p><br>
					...
					<div class="tab-pane active row" id="government">
						<div class="gov_toggle">
							<div class="col-md-3 col-xs-6" >
								<ul class="submenu_ul " >
									<li><a href="#" class="selected_option">Department of Administrative</a></li>
									<li><a href="#" class="selected_option">Department of Biotechnology</a></li>
									<li><a href="#" class="selected_option">Department of Commerce</a></li>
									<li ><a href="#" class="selected_option">Department of Industrial</a></li>
									<li><a href="#" class="selected_option">Separated link</a></li>
								 </ul>
							</div>
							<div class="col-md-3 col-xs-6">
								<ul class="submenu_ul">
						...
						<div>
							<div class="col-md-3 col-xs-12" style="padding-bottom: 10px;">
								<img src="../assets/img/55.jpg" class="size"/><br>
								 <button class="btn " style="width: 80%;height: 45px;margin-top: 60px;font-weight: 500;background: linear-gradient(#ebf904,#ff9703);font-size: 24px;">Say Something</button>	&nbsp;&nbsp;<img src="../assets/images/icon/s-logo.png" style="margin-top: 60px;"/>
							</div>
							<div class="col-md-3 col-xs-12">
								<div><img src="../assets/img/55.jpg" class="size"/></div>
								<div class=" " style="background:white;padding-right:15px;padding-left:15px;">To begin customizing your site go to Appearance -> Customizer and </p></div>
								&nbsp;&nbsp;<div style="text-align:center;padding-bottom: 8px;margin-top: -11px;"><img src="../assets/images/ndtv.jpg" style="height: 50px;width: 200px;"/></div>
							</div>
							<div class="col-md-3 col-xs-12">
								<div><img src="../assets/img/55.jpg" class="size" /></div>
								<div class=""  style="background:white;padding-right:15px;padding-left:15px;"><p>To begin customizing your site go to Appearance -> Customizer and </p></div>
								&nbsp;&nbsp;<div style="text-align:center;padding-bottom: 8px;margin-top: -11px;"><img src="../assets/images/ndtv.jpg" style="height: 50px;width: 200px;"/></div>
							</div>
							<div class="col-md-3 col-xs-12">
								<div><img src="../assets/img/55.jpg" class="size" /></div>
				  ...
				  <div class="tab-pane row" id="myDeskboard">
						<div>
							<div class="col-md-3 col-xs-6">
								<ul class="submenu_ul">
									<li><a href="#"><img src="../assets/images/icon/mail.png" /> &nbsp;&nbsp;Notification</a></li>
									<li><a href="#"><img src="../assets/images/icon/warning.png" /> &nbsp;&nbsp;Attention Required</a></li>
									<li><a href="#"><img src="../assets/images/icon/request.png" /> &nbsp;&nbsp;Friends Requests</a></li>
									<li><a href="#"><img src="../assets/images/icon/followers.png" /> &nbsp;&nbsp;Followers</a></li>
									<li><a href="#"><img src="../assets/images/icon/following.png" /> &nbsp;&nbsp;Following</a></li>
							...
							<div class="col-md-3 col-xs-6">
								<ul class="submenu_ul" >
									<li><a href="#"><img src="../assets/images/icon/elections.png" /> &nbsp;&nbsp;Votes</a></li>
									<li><a href="#"><img src="../assets/images/icon/bookmark.png" /> &nbsp;&nbsp;Bookmarks</a></li>
									<li><a href="#"><img src="../assets/images/icon/request.png" /> &nbsp;&nbsp;Favorite</a></li>
									<li><a href="#"><img src="../assets/images/icon/settings.png" /> &nbsp;&nbsp;Settings</a></li>
									<li><a href="#"><img src="../assets/images/icon/idea.png" /> &nbsp;&nbsp;My Creation</a></li>
									<li><a href="#"><img src="../assets/images/icon/crown.png" /> &nbsp;&nbsp;Successful Polls</a></li>
								</ul>
							</div>
						</div>
				  </div>
           ...
           <div style="" class="container-fluid india_color">
				<div class="row" >
					...
					<div class="col-md-4">
						...
						<h4 style="color:#7e7e82;text-align:center"> You may changes your Vote anytime after 24 hours</h4><br>
					</div>
					<div class="col-md-4">
					</div>
				</div>
				<div class="row" style="height: 18px;background:green;text-align:center;">
					<span class=""  ><i style="font-size:22px" class="fas fa-chevron-down"></i></span>
				</div>
		   </div>	
           <div class="container-fluid">
				<div class="row" style="background:#013775">
					<div class=" col-md-1">
						<span><i style="font-size: 32px;color: white;padding: 10px 30px;" class="fas fa-bars"></i></span>
					</div>
					<?php if(isset($user->id)){ ?>
					<div class="col-md-8 government_option" style="color:white;margin-top: 10px;font-size: 17px;"><?=$showAddress?></div>
					<?php } else { ?>
